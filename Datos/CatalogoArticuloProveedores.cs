...
namespace Datos
{
    public class CatalogoArticuloProveedores : Catalogo
    {
        ...
        private ModeloArticuloProveedores leerDatosArticuloProveedor(SqlDataReader p_drArticulosProveedor)
        {
            ...
            //pasa como parámetro los datos del artículo base y los inicializa en artículo proveedor
            ModeloArticuloProveedores lcl_mod_articuloProveedor = new ModeloArticuloProveedores(lcl_cat_articulos.leerDatosArticulo(p_drArticulosProveedor));
            ...
            lcl_mod_articuloProveedor.descripcionArticuloProveedor = (p_drArticulosProveedor["descripcionArticuloProveedor"] != DBNull.Value) ? (string)p_drArticulosProveedor["descripcionArticuloProveedor"] : null;
            lcl_mod_articuloProveedor.observacionesArticuloProveedor = (p_drArticulosProveedor["observacionesArticuloProveedor"] != DBNull.Value) ? (string)p_drArticulosProveedor["observacionesArticuloProveedor"] : null;
        ...
        private bool updateArticuloProveedor(ModeloArticuloProveedores p_mod_articuloProveedor)
        {
            ...
            comando.CommandText = 
                ...
                "   [codigo_entidad]=@codigo_entidad, [descripcion]=@descripcion,[fecha_actualizacion]=@fecha_actualizacion, [ubicacion]=@ubicacion, "+
                "   [activo]=@activo  "+
