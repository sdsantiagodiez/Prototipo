...
namespace Datos
{
    public class CatalogoEntidades : Catalogo
    {
        ...
        public virtual ModeloEntidad getOne(int p_codigoEntidad)
        {
            ...
            comando.CommandText =
                "SELECT [codigo] as codigo_entidad,[tipo_entidad],[cuit],[observaciones],[activo] " +
                    "FROM [entidades]  " +
        ...
        public virtual bool add(ref ModeloEntidad p_mod_entidad)
        {
            ...
            comando.CommandType = CommandType.Text;
            comando.CommandText =
                "INSERT INTO [entidades] ([tipo_entidad],[cuit],[observaciones],[activo]) " +
                "OUTPUT INSERTED.CODIGO " +
                "VALUES (@tipo_entidad, @cuit, @observaciones,@activo)";
